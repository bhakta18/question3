const supermarketData = {
  ...
  function findProductDetails(supermarketData) {
    ...
    const electronicsInventory = supermarketData.products.electronicsSection.inventory;
    const clothingInventory = supermarketData.products.clothingSection.inventory;
  
    
    const laptopAvailable = electronicsInventory.laptop.available;
    const shirtAvailable = clothingInventory.shirt.available;
  
    
    const laptopPrice = electronicsInventory.laptop.price;
    const shirtPrice = clothingInventory.shirt.price;
  ...
  const details = findProductDetails(supermarketData);
  console.log(details);
